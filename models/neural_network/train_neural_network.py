...
def plot_history(history):
    ...
    plt.savefig('models/neural_network/figures/loss_curve_nn.png', dpi=300, bbox_inches='tight')
    plt.legend()
    plt.grid(True)
    plt.show()
...
plt.savefig('models/neural_network/figures/Receiver_Operating_Characteristic_nn.png', dpi=300, bbox_inches='tight')
...
plt.savefig('models/neural_network/figures/shap_bar_nn.png', dpi=300, bbox_inches='tight')
plt.close()
